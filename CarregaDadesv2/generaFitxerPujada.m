   ...
   % fitxerfinal = 'Z:\matlab\dades\prova_2\Resultats\08_04_14\DadesPlus.txt';
    ...
    for i=1:nf
        ...
        for j=1:32
            ...
            fila = [fila,num2str(aSlope(j)),',',num2str(aPolySlope(1,j)),',',num2str(aPolySlope(2,j)),',',num2str(aPolySlope(3,j)),',',num2str(aPolySlope(4,j)),',',num2str(V_highta(1,j)),',',num2str(V_highta(2,j)),',',num2str(V_highta(3,j)),',',num2str(V_highta(4,j)),',',num2str(V_highta(5,j)),',',num2str(V_hightb(1,j)),',',num2str(V_hightb(2,j)),',',num2str(V_hightb(3,j)),',',num2str(V_hightb(4,j)),',',num2str(V_hightb(5,j)),',',num2str(V_low(1,j)),',',num2str(V_low(2,j)),',',num2str(V_low(3,j)),',',num2str(V_low(4,j)),',',num2str(V_low(5,j)),',',num2str(DV_highta(j)),',',num2str(DV_hightb(j)),',',num2str(DV_low(j)),',',num2str(Dif1(j)),',',num2str(Dif2(j)),','];
